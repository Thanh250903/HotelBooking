...
namespace HotelApp.Areas.Staff.Controllers
{
    ...
    // Staff sẽ có TourNotification: Để nhắc nhở người dùng về chuyến du lịch mà họ đặt  => Method: ListNotification, SendNotification, GetNotification, ResendNotification
