...
namespace HotelApp.Areas.Owner.Controllers
{
    ...
    // Owner sẽ có BookingManagementController: Xem và quản lý các booking mà chủ khách sạn sở hữu => Method: ListBookings, ViewBookingDetails, Checkin, ViewRoomBooking, ViewTourBooking 
